...
return new class extends Migration
{
    ...
    {
        Schema::create('sanghasth_brahmachary_bahanes', function (Blueprint $table) {
            $table->id();
			$table->string('name');
			...
			$table->string('pratimae')->nullable();
			$table->string('pratham_kenshaloch')->nullable();
    ...
    {
        Schema::dropIfExists('sanghasth_brahmachary_bahanes');
    }
};
