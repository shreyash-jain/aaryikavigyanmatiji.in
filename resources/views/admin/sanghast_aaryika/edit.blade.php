			...
			<div class="card">
				<div class="container px-0">
					<div class="card-header ">
						<h2 class="card-title">{{__('sanghast_aaryika.sanghast_aaryika')}}  {{__('sanghast_aaryika.sanghast_aaryika_edit')}}</h2>						
					</div>
				</div>
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
							<div class="p-h-10">
								<form  id="sanghast_aaryika_form" action="{{ route('sanghast_aaryika.update',$data->id) }}" method="POST" enctype="multipart/form-data">
								@csrf
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="mata_ji_name" name="mata_ji_name" value="{{ (isset($data->name) ? $data->name : '')  }}" placeholder=" {{__('sanghast_aaryika.enter_mata_ji_name')}}">
							...
							<div class="col-md-6">
								<div class="p-h-10">
									...
									<div class="text-sm-right">
										<a href="{{route('sanghast_aaryika.list')}}"  class="btn btn-gradient-danger">{{__('button.cancel')}}</a>
