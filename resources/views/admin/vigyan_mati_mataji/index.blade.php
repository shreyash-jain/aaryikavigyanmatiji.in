			...
			<div class="card">
				<div class="container px-0">
					<div class="card-header ">
						<h2 class="card-title">{{__('sanghast_aaryika.vigyan_mati_mataji')}} </h2>						
					</div>
				</div>
				...
				<div class="card-body">
					...
					<form  id="sanghast_aaryika_form" action="{{ route('vigyan_mati_mataji.store') }}" method="POST" enctype="multipart/form-data">
					@csrf
						...
						<div class="row">
							<div class="col-lg-6 col-sm-12">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="mata_ji_name" name="mata_ji_name" value="{{ old('mata_ji_name') . (isset($data->name) ? $data->name : '')  }}" placeholder=" {{__('sanghast_aaryika.enter_mata_ji_name')}}">
							...
							<div class="col-lg-6 col-sm-12">									
								<div class="form-group row">
									<label class="col-sm-3 col-form-label control-label text-sm-right">{{__('sanghast_aaryika.homelessness')}} <span class="text-danger">*</span></label>
									<div class="col-sm-9">
							...
							<div class="col-lg-6 col-sm-12">									
								<div class="form-group row">
									<label class="col-sm-3 col-form-label control-label text-sm-right">{{__('sanghast_aaryika.holding_the_statue')}} <span class="text-danger">*</span></label>
									<div class="col-sm-9">
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group row">
									<label class="col-sm-3 col-form-label control-label text-sm-right">{{__('sanghast_aaryika.interests')}} <span class="text-danger">*</span></label>
									<div class="col-sm-9">
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group row">
									<label class="col-sm-3 col-form-label control-label text-sm-right">{{__('sanghast_aaryika.specialty')}} <span class="text-danger">*</span></label>
									<div class="col-sm-9">
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group row">
									<label class="col-sm-3 col-form-label control-label text-sm-right">{{__('sanghast_aaryika.initiated_disciples')}} <span class="text-danger">*</span></label>
									<div class="col-sm-9">
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="description" value="{{ old('description') . (isset($data->description) ? $data->description : '') }}" name="description" placeholder="{{__('sanghast_aaryika.enter_description')}}">
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group row">
									<label class="col-sm-3 col-form-label control-label text-sm-right">{{__('sanghast_aaryika.saanidhy_and_nirdeshan')}}</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" id="saanidhy_and_nirdeshan" value="{{ old('saanidhy_and_nirdeshan') . (isset($data->saanidhy_and_nirdeshan) ? $data->saanidhy_and_nirdeshan : '') }}" name="saanidhy_and_nirdeshan" placeholder="{{__('sanghast_aaryika.enter_saanidhy_and_nirdeshan')}}">
										@if ($errors->has('saanidhy_and_nirdeshan'))
											<span class="text-danger">{{ $errors->first('saanidhy_and_nirdeshan') }}</span>
										@endif
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<label class=" col-form-label control-label text-sm-right">{{__('sanghast_aaryika.aajeevan_tyaag_niyam')}} </label>
								<div class="m-t-15">
									<textarea class="form-control" name="aajeevan_tyaag_niyam" rows="3"  placeholder="{{__('oshadhi.enter_aajeevan_tyaag_niyam')}}" id="summernote-standard">{{(isset($data->aajeevan_tyaag_niyam) ? $data->aajeevan_tyaag_niyam : '') }}</textarea>
								</div>	
								@if ($errors->has('aajeevan_tyaag_niyam'))
									<span class="text-danger">{{ $errors->first('aajeevan_tyaag_niyam') }}</span>
									@endif 								
							</div>
							<div class="col-lg-12">
