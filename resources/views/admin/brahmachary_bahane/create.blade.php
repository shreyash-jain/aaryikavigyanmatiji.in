			...
			<div class="card">
				<div class="container px-0">
					<div class="card-header ">
						<h2 class="card-title">{{__('sanghast_aaryika.sanghast_brahmacharya_sisters')}}  {{__('sanghast_aaryika.sanghast_aaryika_add')}}</h2>						
					</div>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
							<div class="p-h-10">
								<form  id="sanghast_aaryika_form" action="{{ route('sanghasth_brahmachary_bahane.store') }}" method="POST" enctype="multipart/form-data">
								@csrf
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="name" name="name" value="{{ old('name') . (isset($data->mata_ji_name) ? $data->mata_ji_name : '')  }}" placeholder=" {{__('sanghast_aaryika.enter_mata_ji_name')}}">
											@if ($errors->has('name'))
							...
							<div class="col-md-6">
								<div class="p-h-10">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="pratimae" value="{{ old('pratimae') . (isset($data->pratimae) ? $data->pratimae : '') }}" name="pratimae" placeholder="{{__('sanghast_aaryika.enter_pratimae')}}">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="pratham_kenshaloch" value="{{ old('pratham_kenshaloch') . (isset($data->pratham_kenshaloch) ? $data->pratham_kenshaloch : '') }}" name="pratham_kenshaloch" placeholder="{{__('sanghast_aaryika.enter_pratham_kenshaloch')}}">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="date_place" value="{{ old('date_place') . (isset($data->date_place) ? $data->date_place : '') }}" name="date_place" placeholder="{{__('sanghast_aaryika.enter_date_place')}}">
