...
@section('content')
	<div class="main-body">
		<section class="detail-page-wrap att-2-spacing">	
			<div class="container att-2-container mb-100pxxx p-0">					
				<div class="row p-3">						
					<div class="col-12 col-md-4">						
						<div class="left-sidebar frame-box">							
							<div class="image-box frame-inner-box">							
								<img class="img-100" src="{{asset('frontend/images/aaryika/vighutamati.jpg')}}" alt="Lawyer">		
							</div>						
						</div>				
					</div>				
					<div class="col-12 col-md-8">		  
						<div class="right-content">									
							<div class="lawyer-detail back-white-light mb-40 nopadding text-center">		
								...
								<h4 class="bc-color-dark-red-tcw mb-20 d-block att-head color-whit">आर्यिका श्री 105 विघुतमति माता जी</h4>		
							</div>																												
							...
							<table class="table table_color">								 		
								<tbody>   		
									<tr>								
										...
										<th class="col-9 ">	आर्यिका श्री 105 विघुतमति माता जी	</th>
									</tr>							
									<tr>								
										<th class="col-3" >{{__('sanghast_aaryika_user.old_name')}} </th>		
										<th class="col-9 ">उमराव बाई </th>
									</tr>								
									<tr>					
										<th class="col-3" >{{__('sanghast_aaryika_user.address')}} </th>			
										<th class="col-9 ">आसाम</th>			
									</tr>									
									<tr>					
										<th class="col-3" >{{__('sanghast_aaryika_user.diksha_place')}} </th>			
										<th class="col-9 ">मारोठ (राज.)</th>			
									</tr>																														
									<tr>							
										<th class="" >{{__('sanghast_aaryika_user.initiation_guru')}} </th>		
										<th class="">आचार्य कल्प श्री विवेकसागर जी महाराज</th>			
									</tr>																														
									<tr>							
										<th class="" >{{__('sanghast_aaryika_user.mausoleum')}} </th>		
										<th class="">नसीराबाद (भादवा सुदी छठ, 28 अगस्त 1998)</th>			
									</tr>					
								</tbody>				
							</table>						
						</div>					
