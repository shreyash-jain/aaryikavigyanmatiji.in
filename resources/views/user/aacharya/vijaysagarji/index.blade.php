			...
			<div class="container att-2-container p-0">					
				<div class="row p-3">						
					<div class="col-12 col-md-4">						
						<div class="left-sidebar frame-box">							
							<div class="image-box frame-inner-box">					
								<img class="img-100" src="{{asset('frontend/images/aaryika/vijaysagarji.jpg')}}" alt="Image">		
							</div>						
						</div>				
					</div>		
					<div class="col-12 col-md-8">				
						...
						<h4 class="bc-color-dark-red-tcw mb-20 d-block att-head color-whit">मुनि श्री 108 विजयसागर महाराज जी</h4>	
						</div>																					
						...
						<tr>									
							...
							<th class="col-9 ">मुनि श्री 108 विजयसागर महाराज जी</th>					
						</tr>	 								
						<tr>									
							<th class="col-3" >{{__('aacharya_user.muni_deeksha')}} </th>		
							<th class="col-9 "> रेनवाल ( किशनगढ़ ) </th>					
						</tr>														
																		
						<tr>													
							<th class="col-3" >{{__('aacharya_user.deeksha_guru')}} </th>			
							<th class="col-9 "> आचार्य कल्प विवेक सागर जी महाराज</th>			
						</tr>								
						<tr>						
							<th class="col-3" >{{__('aacharya_user.samaadhi_place')}} </th>			
							<th class="col-9">कूकनवाली</th>					
						</tr>																									
						</tbody>								
						</table>										
						</div>									
